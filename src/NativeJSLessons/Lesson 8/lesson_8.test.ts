...
test("get banknote list", ()=> {
    ...
    const result458 = getBanknoteList(458)
    ...
    expect(result458[0]).toBe(100)
    expect(result458[1]).toBe(100)
    expect(result458[2]).toBe(100)
    expect(result458[3]).toBe(100)
    expect(result458[4]).toBe(50)
    expect(result458[5]).toBe(5)
    expect(result458[6]).toBe(2)
    expect(result458[7]).toBe(1)
